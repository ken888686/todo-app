...
-- For an existing database, mark this migration as applied only after
-- verifying that the database already matches this schema.
...
CREATE TABLE "items" (
    ...
    "expiredAt" TIMESTAMP(3) DEFAULT NOW() + interval '1 day',
